...
pro_3 = Product.create! name: "blue_fish1", piece_price: 18.29, kilo_price: 63.0, active: true , category: cat_2
pro_4 = Product.create! name: "red_fish1", piece_price: 13.02, kilo_price: 70.0, active: true , category: cat_1
pro_5 = Product.create! name: "blue_fish3", piece_price: 15.89, kilo_price: 68.0, active: true , category: cat_2

pro_1.product_images.build(image: file_1)
pro_2.product_images.build(image: file_2)
pro_3.product_images.build(image: file_3)
pro_4.product_images.build(image: file_2)
pro_5.product_images.build(image: file_3)
